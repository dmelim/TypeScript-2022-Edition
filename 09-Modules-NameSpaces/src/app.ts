  ...
  implements DragTarget
{
  ...
  renderContent() {
    const lisdId = `${this.type}-projects-list`;
    this.element.querySelector("ul")!.id = lisdId;
...
class ProjectInput extends Component<HTMLDivElement, HTMLFormElement> {
  ...
  // It's good practice to have public methods first
  configure() {
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    const enteredDescription = this.descriptInputEle.value;
